...
import com.ofc.ofc.model.USDTJiaoyiListModel;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.right_btn:
                ...
                list.add(getString(R.string.qianbao_h157));
                list.add(getString(R.string.qianbao_h158));
                list.add(getString(R.string.qianbao_h159));
                list.add(getString(R.string.qianbao_h160));
