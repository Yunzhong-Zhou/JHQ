...
public class MyDefaultFooter extends BaseFooter {
    ...
    public void onLimitDes(View rootView, boolean upORdown) {
        if (upORdown) {
            footerTitle.setText(context.getString(com.ofc.ofccoin.R.string.app_refresh5));
        } else {
            footerTitle.setText(context.getString(com.ofc.ofccoin.R.string.app_refresh6));
        }
    }
