package com.cfo.chocoin.view.calendarview.widget;
...
import com.cfo.chocoin.view.calendarview.util.DateUtils;
...
public class CalendarView extends View {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        int selectTextColor2 = a.getColor(R.styleable.CalendarView_cv_selectTextColor2, Color.BLACK);
        setSelectTextColor2(selectTextColor2);
        ...
        float selectTextSize2 = a.getDimension(R.styleable.CalendarView_cv_selectTextSize2, sp2px(14));
        setSelectTextSize2(selectTextSize2);
        ...
        Drawable selectDayBackground2 = a.getDrawable(R.styleable.CalendarView_cv_selectDayBackground2);
        setSelectDayBackground2(selectDayBackground2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int day = 1; day <= days; day++) {
            ...
            if(mSelectDate2 == null || mSelectDate2.size() == 0 ||
                ...
                drawText(canvas, dayStr, mSelectTextColor2, mSelectTextSize2, x, y);
            }
