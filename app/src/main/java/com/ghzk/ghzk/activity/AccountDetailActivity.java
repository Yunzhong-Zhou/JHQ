...
import com.ghzk.ghzk.model.AccountDetailModel;
    ...
    private void Request(String string) {
        OkHttpClientManager.getAsyn(this, URLs.AccountDetail + string, new OkHttpClientManager.ResultCallback<AccountDetailModel>() {
            ...
            public void onResponse(AccountDetailModel response) {
                ...
                head1_textView2.setText(response.getEarning_money());//设备收益
                head1_textView3.setText(response.getSell_commission_money());//销售分成
                head1_textView4.setText(response.getEarning_commission_money());//收益分成
