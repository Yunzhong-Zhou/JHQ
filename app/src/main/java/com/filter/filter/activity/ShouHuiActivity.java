...
import com.filter.filter.model.HuiGouModel;
...
//        this.showLoadingPage();
    ...
    private void Request(String string) {
        OkHttpClientManager.getAsyn(ShouHuiActivity.this, URLs.ShouHui + string, new OkHttpClientManager.ResultCallback<HuiGouModel>() {
            @Override
...
//                    hk = response.getHk();
    ...
    private void RequestScavengingPayment(Map<String, String> params) {
        OkHttpClientManager.postAsyn(ShouHuiActivity.this, URLs.ShouHui, params, new OkHttpClientManager.ResultCallback<HuiGouModel>() {
            @Override
                    ...
                    if (info.contains(getString(R.string.password_h1))) {
                        showToast(getString(R.string.password_h2),
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        dialog.dismiss();
                                        CommonUtil.gotoActivity(ShouHuiActivity.this, SetTransactionPasswordActivity.class, false);
                                    }
                                }, new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                        ...
                        showToast(getString(R.string.password_h4),
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        dialog.dismiss();
                                        CommonUtil.gotoActivity(ShouHuiActivity.this, AddressManagementActivity.class, false);
                                    }
                                }, new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
            ...
            public void onResponse(HuiGouModel response) {
                ...
                Request("?token=" + localUserInfo.getToken()
                        + "&id=" + id);
                if (response==null){
                    showToast(getString(R.string.scavengingpayment_h29),
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    dialog.dismiss();
...
//                    params1.put("hk", model.getHk());
    ...
    private void RequestCode(HashMap<String, String> params, final TextView tv, TextView tv_phone) {
        OkHttpClientManager.postAsyn(ShouHuiActivity.this, URLs.Code, params, new OkHttpClientManager.ResultCallback<String>() {
            @Override
            public void onError(Request request, String info, Exception e) {
                hideProgress();
...
//        pullRefreshLayout.setRefreshing(false);
    ...
    protected void updateView() {
        titleView.setTitle(getString(R.string.scavengingpayment_h28));
    }
