...
import com.fone.fone.model.SchoolModel;
...
//        findViewByID_My(R.id.headview).setPadding(0, (int) CommonUtil.getStatusBarHeight(getActivity()), 0, 0);
        ...
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(SchoolActivity.this);
...
//                CommonUtil.gotoActivityWithData(JiFenShangChengActivity.this, JiFenLieBiaoActivity.class, bundle, false);
        ...
        if (LocalUserInfo.getInstance(SchoolActivity.this).getLanguage_Type().equals("zh")){
...
//                                    .error(R.mipmap.headimg)//加载失败
                ...
                mAdapter1.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                        ...
                        CommonUtil.gotoActivityWithData(SchoolActivity.this, WebContentActivity.class, bundle, false);
                    }
