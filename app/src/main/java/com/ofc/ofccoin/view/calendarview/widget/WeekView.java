...
public class WeekView extends View {
    ...
    private String[] mWeeks = {getResources().getString(R.string.app_ri),
            getResources().getString(R.string.app_yi),
            getResources().getString(R.string.app_er),
            getResources().getString(R.string.app_san),
            getResources().getString(R.string.app_si),
            getResources().getString(R.string.app_wu),
            getResources().getString(R.string.app_liu)};
