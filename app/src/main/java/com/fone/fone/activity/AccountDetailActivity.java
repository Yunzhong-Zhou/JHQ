...
import com.fone.fone.model.AccountDetailModel1;
...
//        head1_relativeLayout.setPadding(0, (int) CommonUtil.getStatusBarHeight(AccountDetailActivity.this), 0, 0);
    ...
    private void Request(String string) {
        OkHttpClientManager.getAsyn(this, URLs.AccountDetail + string, new OkHttpClientManager.ResultCallback<AccountDetailModel1>() {
            @Override
