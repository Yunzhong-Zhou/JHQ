package com.filter.filter.view.zxing;
...
import com.filter.filter.view.zxing.camera.CameraManager;
import com.filter.filter.view.zxing.decoding.CaptureActivityHandler;
import com.filter.filter.view.zxing.decoding.InactivityTimer;
import com.filter.filter.view.zxing.decoding.RGBLuminanceSource;
import com.filter.filter.view.zxing.view.ViewfinderView;
