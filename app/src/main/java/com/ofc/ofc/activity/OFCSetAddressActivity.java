...
public class OFCSetAddressActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ofcsetaddress);
    }
...
//        qk = getIntent().getStringExtra("qk");
    ...
    private void request(String string) {
        OkHttpClientManager.getAsyn(OFCSetAddressActivity.this, URLs.WalletAddress + string,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.textView3:
                ...
                OFCSetAddressActivity.this.showProgress(true, getString(R.string.app_sendcode_hint1));
...
//                    params.put("xrp_wallet_addr", xrp_wallet_addr);
    ...
    private void RequestCode(Map<String, String> params) {
        OkHttpClientManager.postAsyn(OFCSetAddressActivity.this, URLs.Code, params, new OkHttpClientManager.ResultCallback<String>() {
            @Override
            public void onError(Request request, String info, Exception e) {
                hideProgress();
    ...
    private void RequestSetWalletAddress(Map<String, String> params) {
        OkHttpClientManager.postAsyn(OFCSetAddressActivity.this, URLs.WalletAddress, params, new OkHttpClientManager.ResultCallback<SetAddressModel>() {
            @Override
            public void onError(Request request, String info, Exception e) {
