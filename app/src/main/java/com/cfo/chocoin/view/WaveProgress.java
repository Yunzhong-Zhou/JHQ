...
import com.cfo.chocoin.BuildConfig;
...
public class WaveProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mDefaultSize = CommonUtil.dip2px(context, Constant.DEFAULT_SIZE);
        mRectF = new RectF();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBgColor = typedArray.getColor(R.styleable.WaveProgress_bgColor, Color.TRANSPARENT);
    ...
    private void initPaint() {
        ...
        circlePaint.setStyle(Paint.Style.FILL);//画笔属性是空心圆
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(CommonUtil.measure(widthMeasureSpec, mDefaultSize),
                CommonUtil.measure(heightMeasureSpec, mDefaultSize));
    }
    ...
    private Point[] getPoint(boolean isR2L, float waveWidth) {
        ...
        return isR2L ? CommonUtil.reverse(points) : points;
    }
